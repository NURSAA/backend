 ...
 */
final class Version20230126192016 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dish_orders (id INT AUTO_INCREMENT NOT NULL, order_id INT NOT NULL, dish_id INT NOT NULL, details VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, status VARCHAR(255) NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, soft_delete TINYINT(1) NOT NULL, INDEX IDX_ED28FAE18D9F6D38 (order_id), INDEX IDX_ED28FAE1148EB0CB (dish_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `dishes` (id INT AUTO_INCREMENT NOT NULL, file_id INT DEFAULT NULL, menu_section_id INT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, price INT NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, soft_delete TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_584DD35D93CB796C (file_id), INDEX IDX_584DD35DF98E57A8 (menu_section_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `files` (id INT AUTO_INCREMENT NOT NULL, original_name VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, soft_delete TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `floors` (id INT AUTO_INCREMENT NOT NULL, restaurant_id INT NOT NULL, level INT NOT NULL, name VARCHAR(255) NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, soft_delete TINYINT(1) NOT NULL, INDEX IDX_C7668712B1E7706E (restaurant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `ingredient_groups` (id INT AUTO_INCREMENT NOT NULL, restaurant_id INT NOT NULL, name VARCHAR(255) NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, soft_delete TINYINT(1) NOT NULL, INDEX IDX_1C17F931B1E7706E (restaurant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `ingredients` (id INT AUTO_INCREMENT NOT NULL, ingredient_group_id INT NOT NULL, name VARCHAR(255) NOT NULL, price INT NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, soft_delete TINYINT(1) NOT NULL, INDEX IDX_4B60114F8C5289C9 (ingredient_group_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `menu_sections` (id INT AUTO_INCREMENT NOT NULL, menu_id INT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, section_order INT NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, soft_delete TINYINT(1) NOT NULL, INDEX IDX_7C7060ECCD7E912 (menu_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `menus` (id INT AUTO_INCREMENT NOT NULL, restaurant_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, soft_delete TINYINT(1) NOT NULL, INDEX IDX_727508CFB1E7706E (restaurant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `orders` (id INT AUTO_INCREMENT NOT NULL, reservation_id INT NOT NULL, payment_id INT NOT NULL, status VARCHAR(255) NOT NULL, amount INT NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, soft_delete TINYINT(1) NOT NULL, INDEX IDX_E52FFDEEB83297E7 (reservation_id), UNIQUE INDEX UNIQ_E52FFDEE4C3A3BB (payment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE payments (id INT AUTO_INCREMENT NOT NULL, amount DOUBLE PRECISION NOT NULL, status VARCHAR(255) NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, soft_delete TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reservations (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, restaurant_id INT NOT NULL, start DATE NOT NULL, end DATE NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, soft_delete TINYINT(1) NOT NULL, INDEX IDX_4DA239A76ED395 (user_id), INDEX IDX_4DA239B1E7706E (restaurant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `restaurants` (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, url VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, soft_delete TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `tables` (id INT AUTO_INCREMENT NOT NULL, floor_id INT NOT NULL, name VARCHAR(255) NOT NULL, seats INT NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, soft_delete TINYINT(1) NOT NULL, INDEX IDX_84470221854679E2 (floor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `users` (id INT AUTO_INCREMENT NOT NULL, restaurant_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, first_name VARCHAR(180) NOT NULL, last_name VARCHAR(180) NOT NULL, phone VARCHAR(20) NOT NULL, role VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, soft_delete TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_1483A5E9E7927C74 (email), INDEX IDX_1483A5E9B1E7706E (restaurant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
